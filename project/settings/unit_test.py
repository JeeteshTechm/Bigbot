...
KEYCLOAK_CONFIG = {
    "KEYCLOAK_SERVER_URL": os.getenv("KEYCLOAK_SERVER_URL", "http://127.0.0.1:8081/"),
    "KEYCLOAK_REALM": os.getenv("KEYCLOAK_REALM", "poc"),
    "KEYCLOAK_CLIENT_ID": os.getenv("KEYCLOAK_CLIENT_ID", "poc"),
    "KEYCLOAK_CLIENT_SECRET_KEY": os.getenv("KEYCLOAK_CLIENT_SECRET_KEY", "Beu2ZT0nZIBCHGnPtElUDMeJU4BleDIM"),
